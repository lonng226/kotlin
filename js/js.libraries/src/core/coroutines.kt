...
): Continuation<Unit> = this.asDynamic().call(receiver, withDispatcher(completion, dispatcher), true)
...
public fun <T> (suspend () -> T).createCoroutine(
        completion: Continuation<T>,
        dispatcher: ContinuationDispatcher? = null
): Continuation<Unit> = this.asDynamic()(withDispatcher(completion, dispatcher), true)
